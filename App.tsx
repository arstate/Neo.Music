...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen h-[100dvh] w-full flex-col overflow-hidden font-mono text-black selection:bg-neo-pink selection:text-white">
      ...
      <footer className="z-50 flex-none border-t-4 border-black bg-white p-2 pb-[calc(env(safe-area-inset-bottom)+3.5rem)] md:pb-[calc(env(safe-area-inset-bottom)+1rem)] shadow-[0px_-4px_0px_0px_rgba(0,0,0,1)] transition-all">
